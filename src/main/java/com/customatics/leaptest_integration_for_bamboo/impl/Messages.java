...
public final class Messages {
    ...
    public static final String REPORT_FILE_NOT_FOUND = "Couldn't find report file! Wrong path! Maybe it was not created or something did not allow to do this";
    ...
    public static final String PLUGIN_SUCCESSFUL_FINISH = "Leaptest for Bamboo  plugin  successfully finished!";
    public static final String PLUGIN_ERROR_FINISH = "Leaptest for Bamboo plugin finished with errors!";
    ...
    public static final String INTEGRATION = "Bamboo-Integration";
