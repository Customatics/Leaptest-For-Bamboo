...
public class LogMessages {
    ...
    public final String REPORT_FILE_NOT_FOUND = "Couldn't find report file! Wrong path! Check your report file name in Leaptest Integration task configuration and in JUnit Parser. They MUST match! ";
    ...
    public final String PLUGIN_SUCCESSFUL_FINISH = "Leaptest for Bamboo  plugin  successfully finished!";
    public final String PLUGIN_ERROR_FINISH = "Leaptest for Bamboo plugin finished with errors!";
